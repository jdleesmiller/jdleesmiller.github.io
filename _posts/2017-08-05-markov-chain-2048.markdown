...
We can also obtain the variance for the minimum number of moves using the formula
\\[
...
Finally, to test out these results in real life, I played a lot of 2048 (for science!) and, for the 28 games in which I won, recorded the number of moves it took:

<p align="center">
<img src="/assets/2048/wins.png" alt="Montage of 28 winning games of 2048" />
</p>

For each screenshot, I recorded the number of moves and the sum of the tiles on the board. The sum of the tiles on the board is important, because when it's large, that means that I made some embarrassing blunder) unable

<p align="center">
<img src="/assets/2048/markov_chain_human.svg" alt="TODO" />
</p>

TODO: Write up results.
